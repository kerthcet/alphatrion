...
Revision ID: 95f5ca0ad2d8
Revises: 
Create Date: 2026-03-26 00:22:27.431798
...
def upgrade() -> None:
    ...
    sa.Column('org_id', sa.UUID(), nullable=False, comment='Organization ID'),
